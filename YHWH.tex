...
\documentclass[oneside,11pt,sumario=tradicional,brazil]{abntex2} % Font size
...
\ThisCenterWallPaper{1.12}{img/capa.png} % Add the background image, the first argument is the scaling - adjust this as necessary so the image fits the entire page
